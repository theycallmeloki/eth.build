...
function SaveDialog(props) {
    ...
    const [threeBoxConnectionStep, setThreeBoxConnectionStep] =
        React.useState(0);
      ...
      <Divider /> */}
                            ...
                            <Tooltip title="Save to your 3Box space">
                                <Button
                                    ...
                                    onClick={() => {
                                        ...
                                        if (box && space) {
                                            console.log(
                                                '3BOX is already open and available',
                                            );
                                            changeTo3BoxSavePage();
                                        }
                                    }}
            ...
            {saveType === '3BOX_SCREEN' && (
                <>
                    ...
                    >
                        <Stepper
                            alternativeLabel
                            activeStep={threeBoxConnectionStep}
                        >
                            <Step>
                ...
                <>
                    <div style={{ padding: 32, textAlign: 'center' }}>
                        ...
                        <Typography
                            ...
                            display="block"
                        >
                            You can save your eth.build file directly to your
                            3Box private space. This means that it is saved
                            encrypted on IPFS and only you can access to it.
                        </Typography>
                        <TextField
                            fullWidth
                            name="title"
            ...
            /> */}
                        ...
                        <Button
                            ...
                            disabled={
                                (currentDocumentInfo &&
                                    currentDocumentInfo.document.data ===
                                        compressed) ||
                                saving
                            }
                        >
