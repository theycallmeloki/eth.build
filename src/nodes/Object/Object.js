...
ObjectObject.prototype.onExecute = function () {
    ...
    for (let key in this.value) {
        ...
        if (
            typeof thisInput != 'undefined' &&
            thisInput != null &&
            (typeof thisInput != 'number' || !isNaN(thisInput)) &&
            thisInput != this.value[key]
        ) {
