...
Uniswap.prototype.onExecute = async function () {
    ...
    this.setOutputData(2, {
        ...
        function: async (args) => {
            ...
            let outputPrice = await thisContract.methods
                .getTokenToEthOutputPrice(10000000)
                .call();
            try {
    ...
    this.setOutputData(3, {
        ...
        function: async (args) => {
            ...
            let tokensIn = this.web3.utils.fromWei(
            ...
            let eth_bought =
                (tokensIn / (outputPrice / 10000000)) * 0.997 * 10 ** 18;
