...
Compile.prototype.compile = function (name) {
    ...
    axios
        .post('https://solc.eth.build:48451/', solcObject)
        .then((response) => {
            ...
            if (
                this.properties.compiled.errors &&
                this.properties.compiled.errors[0] &&
                this.properties.compiled.errors[0].message
            ) {
                ...
                for (let e in this.properties.compiled.errors) {
                    if (this.properties.compiled.errors[e].type != 'Warning') {
                        global.setSnackbar({
                            msg: this.properties.compiled.errors[e]
                                .formattedMessage,
                        });
                        break;
                    }
            ...
            let compiledContractObject =
                this.properties.compiled.contracts[name + '.sol'][name];
